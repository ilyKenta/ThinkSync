...
describe('RevMessage Page', () => {
  ...
  describe('Initial Render', () => {
    it('should render the reviewer messaging page with correct layout', async () => {
      render(<Page />);
      await waitFor(() => {
        expect(screen.getByText('ThinkSync')).toBeInTheDocument();
        expect(screen.getByText('Reviewer Messages')).toBeInTheDocument();
        expect(screen.getByText('Inbox')).toBeInTheDocument();
      });
    });

    it('should display reviewer navigation menu items', async () => {
      render(<Page />);
      await waitFor(() => {
        expect(screen.getByText('Assigned proposals')).toBeInTheDocument();
  ...
  // Navigation Tests
  describe('Navigation', () => {
    it('should navigate to review dashboard', async () => {
      render(<Page />);
      await waitFor(() => {
        fireEvent.click(screen.getByText('Assigned proposals'));
